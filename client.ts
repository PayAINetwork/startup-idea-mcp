...
export const getClient = async () => {
  ...
  const EVM_PRIVATE_KEY = process.env.EVM_PRIVATE_KEY_CLIENT as `0x${string}`;
  const SOLANA_PRIVATE_KEY = process.env.SVM_PRIVATE_KEY_CLIENT as string;
  ...
  return withX402Client(client, {
    ...
    maxPaymentValue: BigInt(10000000),
